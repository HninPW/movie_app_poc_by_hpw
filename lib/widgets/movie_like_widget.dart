...
class MovieLikeWidget extends StatelessWidget {
  const MovieLikeWidget({Key? key,required this.movieCardwidth, required this.movieCardheight, required this.votes, required this.imageURL,required this.movieName, required this.rating}) : super(key: key);
                ...
                child: Column(
                  children: [
                    Align(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only( left:kSP5x,top: kSP180x,bottom: kSP10x,),
                        child: Text(
                          movieName,
